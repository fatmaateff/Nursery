...
exports.updateChild = (req, res) => {
  Child.updateOne({ _id: req.params.id }, req.body) // Use req.body for the update operation
    .then((result) => {
...
exports.deleteChild = (req, res) => {
  Child.deleteOne({ _id: req.params.id }) // Use req.params.id to specify which document to delete
    .then((result) => {
